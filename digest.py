...
generate_graphs(0, 'ipv4', 'global', dir_path, 'ipv4-figure.png')
generate_graphs(0, 'ipv6', 'global', dir_path, 'ipv6-figure.png')
write_daily_digest(
    dir_path,
    'README.md',
    global_results,
...
generate_graphs(0, 'ipv4', 'afrinic', dir_path + 'archives/AFRINIC/', 'ipv4-figure.png')
generate_graphs(0, 'ipv6', 'afrinic', dir_path + 'archives/AFRINIC/', 'ipv6-figure.png')
write_daily_digest(
...
generate_graphs(0, 'ipv4', 'apnic', dir_path + 'archives/APNIC/', 'ipv4-figure.png')
generate_graphs(0, 'ipv6', 'apnic', dir_path + 'archives/APNIC/', 'ipv6-figure.png')
write_daily_digest(
...
generate_graphs(0, 'ipv4', 'arin', dir_path + 'archives/ARIN/', 'ipv4-figure.png')
generate_graphs(0, 'ipv6', 'arin', dir_path + 'archives/ARIN/', 'ipv6-figure.png')
write_daily_digest(
...
generate_graphs(0, 'ipv4', 'lacnic', dir_path + 'archives/LACNIC/', 'ipv4-figure.png')
generate_graphs(0, 'ipv6', 'lacnic', dir_path + 'archives/LACNIC/', 'ipv6-figure.png')
write_daily_digest(
...
generate_graphs(0, 'ipv4', 'ripencc', dir_path + 'archives/RIPE_NCC/', 'ipv4-figure.png')
generate_graphs(0, 'ipv6', 'ripencc', dir_path + 'archives/RIPE_NCC/', 'ipv6-figure.png')
write_daily_digest(
