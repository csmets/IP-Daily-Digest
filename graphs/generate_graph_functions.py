...
def create_graph(graph_title, current_data, past_data, xa_data, xb_data, y_label, position):
    plt.subplot(position)
    plt.plot(xa_data, current_data, label='Current month')
    plt.plot(xb_data, past_data, label='Last month')
    plt.ylabel(y_label)
